...
namespace hal
{
    ...
    constexpr unsigned long BSCSL_Base = Peripheral_Base + 0x00214000;

    enum class BSCSL_Reg
    {
        Data = 0,
        Status_And_Error_Clear = 1,
        Slave_Address = 2,
        Control = 3,
        Flag = 4,
        Interrupt_FIFO_Level_Select = 5,
        Interrupt_Mask_Set_Clear = 6,
        Raw_Interrupt_Status = 7,
        Masked_Interrupt_Status = 8,
        Interrupt_Clear = 9,
        DMA_Control = 10,
        Test_Data = 11,
        GPUSTAT = 12,
